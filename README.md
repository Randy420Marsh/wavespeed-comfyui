...
## Requirements
Before using this node, you need to have a WaveSpeed AI API key. You can obtain your API key from the [WaveSpeed AI Dashboard](https://wavespeed.ai/dashboard).
...
For pricing information, please visit [WaveSpeed AI Pricing](https://wavespeed.ai/pricing).
